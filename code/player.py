...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, pos, group, collision_sprites):
        ...
        self._PlayerRightWaterImage = pygame.image.load("../textures/playerbluerightwater.png").convert_alpha()
        self._PlayerRightWaterImage2 = pygame.image.load("../textures/playerbluerightwater2.png").convert_alpha()
        self._PlayerLeftWaterImage = pygame.image.load("../textures/playerblueleftwater.png").convert_alpha()
        self._PlayerLeftWaterImage2 = pygame.image.load("../textures/playerblueleftwater2.png").convert_alpha()
        self._playerUpWaterImage = pygame.image.load("../textures/playerblueupwater.png").convert_alpha()
        self._playerUpWaterImage2 = pygame.image.load("../textures/playerblueupwater2.png").convert_alpha()
        self._PlayerDownWaterImage = pygame.image.load("../textures/playerbluedownwater.png").convert_alpha()
        self._PlayerDownWaterImage2 = pygame.image.load("../textures/playerbluedownwater2.png").convert_alpha()
